...
def sqrt_init(shape, dtype=None):
    value = (1 / math.sqrt(2)) * K.ones(shape)  #syn 原本是K.sqrt(2)
    return value
...
def complex_standardization(input_centred, Vrr, Vii, Vri,
    ...
    s = K.sqrt(delta) # Determinant of square root matrix  #原本是np.sqrt
    t = K.sqrt(tau + 2 * s)
    ...
    """
    #============================================================================
    # I guess this part has some problem. For instance, if axis==1 and ndim==4,
    # the program flow will go through the first 'if' branch, which seems not correct.
    # So the code below are revised as the following. Morewhile, to extend the code
    # to deal with general n-D tensors, the code uses the '...' operator to denote
    ...
    if ndim == 2:
        ...
        raise ValueError(
            'Incorrect axis or dimensions. Axis should be either 1 or -1. The number of dimensions '
            'should be not less than 2.'
            )
    # The above are the revised code.
    #=======================================================================
...
def ComplexBN(input_centred, Vrr, Vii, Vri, beta,
               ...
               center=True, layernorm=False, axis=-1,name='ComplexBN'):
    ...
    if scale:
        ...
        #==========================================================================
        # The same problem as the corresponding code in complex_standardization
        """
        if (axis == 1 and ndim != 3) or ndim == 2:
        ...
        # The above are the revised code. by J.Wang
        #===========================================================================
...
class ComplexBatchNormalization(Layer):
    ...
    def call(self, inputs, training=None):
        ...
        #=============================================================================
        # The same problem to the corresponding part in the complex_standardization()
        """
        ...
        #====================================================================
        # The following three lines are revised.
        """
        if training in {0, False}:
            return input_bn
        else:
        """
        if training or training is None:  # This line is used to replaced the three lines above. by J.Wang
            update_list = []
            if self.center:
